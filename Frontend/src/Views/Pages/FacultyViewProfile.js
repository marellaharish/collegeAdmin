                ...
                <div className="main__bodySub">
                    ...
                    <div className="Faculty__Bg">
                        <div className="Faculty__Profiles__bg">
                            <img src={Avathar1} className="Faculty__image" />
                            <MDBRow>
                                <MDBCol size={4}>
                                    <div className="d-flex align-items-start flex-column ps-5">
                                        <h1 className="fw-bold">Dr. Arthi B</h1>
                                        <div className="d-flex align-items-center mt-4">
                                            <img src={GraduateCap} className="Graduate__icons" /><p className="m-0 ms-2">Professor and Head</p>
                                        </div>
